        ...
        <div class="modal-content">
            <form action="/user/<?= $user->action; ?><?= '/' . $user->id; ?>" method="post">
                <div class="modal-header">
                    ...
                    <button type="button" name="button" class="close" data-dismiss="modal" aria-hidden="true">&times;
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="gender" class="form-control" required>
                            ...
                            <?php foreach ($user->gender_values as $genderName => $gender): ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" required>
                            <option hidden></option>
                            <?php foreach ($user->status_values as $statusName => $status): ?>
